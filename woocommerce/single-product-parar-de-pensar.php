  ...
  <section class="gertha alt lateral_m">
            ...
            while(true){
                if(get_post_meta(get_the_ID(), 'G_programa_'.$i.'_text', true)){ ?>
                    <div class="pista_group">
                        <p class="pista_txt pista_time"><?php echo get_post_meta(get_the_ID(), 'G_programa_'.$i.'_time', true); ?></p>
                        <p class="pista_txt pista_text"><?php echo get_post_meta(get_the_ID(), 'G_programa_'.$i.'_text', true); ?></p>
                    </div>
                    <?php
                    $i=$i+1;
                } else { break; }
    ...
    <section class="col_2_block">
      ...
      <div class="col_2_block_col">
        ...
        <p class="col_2_bloct_txt font_size_5">Creado e impartido por <a class="content_link" href="#">Geoffrey molloy</a> & <a class="content_link" href="#">Rhea Sivi</a> (clica en los nombres para saber más)</p>
      </div>
    </section>
