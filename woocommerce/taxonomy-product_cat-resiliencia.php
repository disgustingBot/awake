...
<section class="flati">
    ...
    <section class="showcase4 tall_img">
        ...
        <h3 class="showcase_title alt simple_title font_size_2">Resiliencia & Mindfulness: Descubre Nuestros Programas</h3>
        ...
        <section class="showcase3">
            <p class="showcase_title font_size_4 simple_title" style="color:<?php echo get_term_meta( get_queried_object()->term_id, 'lt_meta_color', true ); ?>">Herramientas que te servirán para...</p>
