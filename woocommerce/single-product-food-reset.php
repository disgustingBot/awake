...
<?php while(have_posts()){the_post(); ?>
  ...
  <section class="showcase2">
    ...
    <div class="pista">
      <h5 class="pista_title alt font_size_5">¿Qué aprenderás?</h5>

      <?php $i = 1;
      while(true){
        if(get_post_meta(get_the_ID(), 'B_programa_texto_'.$i, true)){ ?>
          <div class="pista_group">
            <p class="pista_txt alt font_size_7"><?php echo get_post_meta(get_the_ID(), 'B_programa_texto_'.$i, true); ?></p>
          </div>
          <?php
          $i=$i+1;
        } else { break; }
  ...
  <section class="col_2_block">
    <h3 class="block_title font_size_4" style="color: <?php echo $category_color; ?>"><?php echo get_post_meta(get_the_ID(), 'C_segunda_descripcion_titulo', true); ?></h3>
    <div class="col_2_block_col">
    ...
    <div class="col_2_block_col">
      ...
      <p class="block_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'C_segunda_descripcion_texto_4', true); ?></p>
    </div>
  </section>
