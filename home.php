...
?>
 ...
 <section class="phil button_phil" data-cycle-container="filters">
   <a class="btn phil_btn" href="https://theresilienthumanproject.com/blog/" target="_blank">Also in English</a>

  <?php $blog_id = get_option('page_for_posts'); ?>
  <p class="phil_caption font_size_7"><?php echo get_post_meta($blog_id, 'A_texto_cabecera', true); ?></p>
