...
<div class="container_1366">
  ...
  <div class="col_2_media">
    <div class="col_2_media_caption">
      <p class="col_2_media_txt font_size_6"><strong><?php echo get_post_meta(get_the_ID(), 'B_texto_contacto_titulo', true)?></strong></p>
      <p class="col_2_media_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'C_direccion_1', true)?></p>
      <p class="col_2_media_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'C_direccion_2', true)?></p>
      <p class="col_2_media_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'D_email', true)?></p>
      <p class="col_2_media_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'E_telefono', true)?></p>
      <br>
      <p class="col_2_media_txt font_size_6"><strong><?php echo get_post_meta(get_the_ID(), 'F_indicaciones_titulo', true)?></strong></p>
      <p class="col_2_media_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'G_indicacion_1', true)?></p>
      <p class="col_2_media_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'G_indicacion_2', true)?></p>
      <p class="col_2_media_txt font_size_6"><?php echo get_post_meta(get_the_ID(), 'G_indicacion_3', true)?></p>
    </div>
